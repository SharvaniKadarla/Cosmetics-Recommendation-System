...
![Brand Distribution Analysis](https://i.postimg.cc/3xG5GYJG/2.png)
...
![Product Type Distribution Analysis](https://i.postimg.cc/43TCbqmS/3.png)
...
![Skin Type Suitability Analysis](https://i.postimg.cc/ncgfMCZZ/4.png)
...
![Analysis of notable effects](https://i.postimg.cc/15fZ9DkJ/5.png)
...
![Difference between Collaborative and Content-Based Filtering](https://i.postimg.cc/TwRZBbjj/6.png)
...
![TF-IDF](https://i.postimg.cc/TPjzk0bY/7.png)
...
![Cosine Similarity](https://i.postimg.cc/DZBthz59/8.png)
...
![Recommendations Generated](https://i.postimg.cc/J00SzW2G/9.png)
...
![Architecture for Cosmetics Recommendation System](https://i.postimg.cc/mknJc6vV/10.png)
...
![Website look of the Cosmetics Recommendation System](https://i.postimg.cc/tRvLmYsP/11.png)

When the user clicks on the home page, the page appears like this:

![Home Page](https://i.postimg.cc/9F4v3C9k/12.png)
...
![Get Recommendation Page](https://i.postimg.cc/GhZ6dVJm/13.png)

When the user clicks on the Skin Care Guide page, the page looks like this:

![Skin Care Guide Page](https://i.postimg.cc/nL1WKz8X/14.png)

When the user clicks on the contact page, the page looks like this

![Contact Page](https://i.postimg.cc/MpVNT5db/15.png)
## Conclusion
